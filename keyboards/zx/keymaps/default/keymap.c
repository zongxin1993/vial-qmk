...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT, KC_Z,    KC_X,  KC_C,    KC_V,   KC_B,    XXXXXXX, XXXXXXX,   KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  QK_LEAD, KC_UP,    OSL(2),
    ...
    [1] = LAYOUT(
        ...
        KC_LSFT, KC_NO,   KC_NO, KC_NO,   KC_NO,  KC_NO,   XXXXXXX, XXXXXXX,   KC_NO,  KC_NO,   KC_MPRV, KC_MNXT, KC_MPLY, QK_LEAD, KC_PGUP, KC_NO,
    ...
    [2] = LAYOUT(
        KC_GRV,  RM_TOGG, RM_PREV, RM_NEXT, KC_NO,  KC_NO,   KC_NO,   XXXXXXX,   KC_7,   KC_8,    KC_9,    KC_0,    KC_MINS,  KC_EQL,  KC_BSPC, XXXXXXX,
        KC_TAB,  KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO,   KC_NO,   XXXXXXX,   KC_4,   KC_5,    KC_6,    KC_NO,   KC_LBRC,  KC_RBRC, KC_BSLS, XXXXXXX,
        KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,  XXXXXXX, XXXXXXX, XXXXXXX,   KC_NO,  KC_1,    KC_2,    KC_3,    KC_SCLN,  KC_QUOT, KC_ENTER,XXXXXXX,
        KC_LSFT, KC_NO,   KC_NO,   KC_NO,   KC_NO,  KC_NO,   XXXXXXX, XXXXXXX,   KC_NO,  KC_NO,   KC_COMM, KC_DOT,  KC_SLSH,  KC_NO,   KC_UP,   OSL(2),
        KC_LCTL, KC_LGUI, KC_NO,   KC_LALT, KC_SPC, XXXXXXX, XXXXXXX, XXXXXXX,   KC_APP, KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT, XXXXXXX, XXXXXXX, XXXXXXX
    )
};
